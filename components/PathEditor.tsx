...
export function PathEditor({ compact = false }: Props = {}) {
  ...
  const copySvg = async () => {
    const svgString = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${VB} ${VB}" fill="none" stroke="#5ec5ff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
  <path d="${d}" />
</svg>`
    try {
